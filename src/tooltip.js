const Tooltip = (() => {
    ...
    const changeMenuTooltipTextOpen = () => (menuButtonTooltip.textContent = 'Open menu')
    const changeMenuTooltipTextClose = () => (menuButtonTooltip.textContent = 'Close menu')

    hideTooltipOnClick()

    return {
        changeMenuTooltipTextOpen, changeMenuTooltipTextClose,
    }
})()
